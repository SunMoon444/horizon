...
<body class="no-skin <path:prop name="embed"/> hidden-sidebar2" data-layout="<path:prop  file="configuration" name="layout.operator"/>" data-fixed-modal="<path:prop name="layout.fixedModal"/>">
            ...
            <div class="navbar-buttons navbar-header pull-right collapse navbar-collapse" role="navigation">
                <ul class="nav ace-nav">
                    <li class="transparent">
                        <span id="licenseInfo" class="badge btn-info"></span>
                    </li>
                    <li class="transparent">
                        <path:permission bizId="app_space" resourceAuth="TEANANT_MANAGE">
                        <a data-rel="tooltip" data-placement="bottom" title="<path:i18n group="base" key="manager" />" href="<path:ctx/>/horizon/manager/index.jsp" target="_blank">
                    ...
                    <li class="transparent no-border">
                        <path:permission bizId="app_space" resourceAuth="TEANANT_DESINGER">
                            <a data-rel="tooltip" data-placement="bottom" title="<path:i18n group="base" key="designer" />" href="<path:ctx/>/horizon/module/flash/flow/moduledesigner<path:urlSuffix/>" target="_blank">
                    ...
                    <li class="transparent">
                        ...
                        <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="#page/widget.analysis" id="defaultHome" data-operator="defaultHome">
                                    <i class="ace-icon fa fa-home"></i><path:i18n group="base" key="defaultHome" />
                                </a>
                            </li>
                            <li>
                                <a href="#page/widget.custom">
                                    <i class="ace-icon fa fa-cog"></i><path:i18n group="base" key="homeCustom" />
                                </a>
                            </li>
                            <li>
                                <a href="#page/custom.opinion">
                                    <i class="ace-icon fa  fa-pencil-square-o"></i><path:i18n group="base" key="opinion" />
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" id="updatePassword" data-operator="updatePassword">
                                    <i class="ace-icon fa fa-key"></i><path:i18n group="base" key="updatePassword" />
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
    ...
    <div class="main-container hidden-print" id="main-container">
        <div id="sidebar" data-auto-hide="true" class="horizon-sidebar sidebar h-sidebar navbar-collapse collapse sidebar-fixed">
            <a class="hide" data-parentid="root" data-url="../module/widget/widget.analysis.html" data-type="ajax" data-children="false" id="widget-analysis" href="#page/widget.analysis"></a>
            <a class="hide" data-parentid="root" data-url="opinion/custom.opinion.html" data-type="ajax" data-children="false" id="custom-opinion" href="#page/custom.opinion"></a>
            <a class="hide" data-parentid="root" data-url="../module/widget/widget.custom.html" data-type="ajax" data-children="false" id="custom-widget" href="#page/widget.custom"></a>
            <!-- 横向菜单  -->
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <span class="input-icon input-icon-right">
                                <input type="password" name="password" minlength="6" maxlength="16" id="newPassword"  autocomplete="off" required/>
                                <i class="ace-icon fa fa-lock blue"></i>
                            </span>
                            <span class='span-null'></span>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <span class="input-icon input-icon-right">
                                <input type="password" name="repassword"  minlength="6" maxlength="16"  autocomplete="off" />
                                ...
                                <div class="widget-menu">
                                    ...
                                    <ul class="dropdown-menu dropdown-light-blue dropdown-caret dropdown-closer">
                                        <li class="hidden menu-tls">
                                            <a href="javascript:void(0);" data-toggle="tab"> <path:i18n group="base" key="newWindows" /> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script data-main="<path:ctx/>/horizon/assets/operator/index/js/operator" src="<path:frontPath/>/require/require.js"></script>
</body>
</html>