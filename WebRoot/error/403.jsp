				...
				<h1 class="grey lighter smaller">
					<span class="blue bigger-125">
						<i class="ace-icon fa fa-random"></i>
						   <path:i18n group="error" key="titleErrorPrompt" />
					</span>
					<path:i18n group="error" key="noPermission" />
				</h1>

				<hr />
				<h3 class="lighter smaller">
					<path:i18n group="error" key="contactAdministrator" />
					<i class="ace-icon fa fa-wrench icon-animated-wrench bigger-125"></i>
					<path:i18n group="error" key="noPermissionPrompt" />
				</h3>
